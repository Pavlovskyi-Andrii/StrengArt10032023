...
# img_path = Сюда подставляем данные из базы данных
# radius = Сюда подставляем данные из базы данных
# nPins = Сюда подставляем данные из базы данных
# nLines = Сюда подставляем данные из базы данных
